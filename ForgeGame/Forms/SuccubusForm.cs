...
{
    public partial class SuccubusForm : Form
    {
        Board board;
        int player;
        public SuccubusForm(Board b, int p)
        {
            InitializeComponent();
            this.board = b;
            this.player = p;
